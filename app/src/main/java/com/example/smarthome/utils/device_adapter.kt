...
class device_adapter(private var DeviceList: List<DeviceList>, private val onClickListener: OnClickListener, private val onCheckListener : OnCheckedEvent) :
    ...
    inner class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        var name: TextView = itemView.findViewById(R.id.icon_name)
        var image: ImageView = itemView.findViewById(R.id._icon)
        var switch: SwitchCompat = itemView.findViewById(R.id.dv_icon)
